...
import 'package:flutter_play/event/event_bus.dart';
import 'package:flutter_play/model/user_info.dart';
import 'package:flutter_play/model/user_info_cache.dart';
...
import 'package:flutter_play/views/main_page.dart';
                          ...
                          FlatButton(
                            ...
                            onPressed: () {
                              Application.router.navigateTo(context,
                                  '${Routes.webViewPage}?title=about&url=${Uri.encodeComponent("https://github.com/ShellRay/flutter_play/blob/master/README.md")}');
                            },
                          ),
                          FlatButton(
                            child: Text(
